...
/**
 * Description: Sort the answers according to their scores and output the result and precision@N.
 */
public class Evaluator extends JCasAnnotator_ImplBase {
  ...
  public void process(JCas aJCas) throws AnalysisEngineProcessException {
    ...
    System.out.println("Precision at " + cntTrue + ": " + precision);
  }
}

/**
 * Description: In MyEntry, key is score of an answer, value is an Answer, and it implements the
 * Comparable interface, which makes the sorting more convenient.
 */
